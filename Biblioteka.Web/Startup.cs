...
namespace Biblioteka.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string connString = @"Data Source=195.130.32.34,1032;Database=Biblioteka;User Id=sa; Password=pmf911; Integrated Security=False";

            services.AddDbContextPool<LibContext>(options => options.UseSqlServer(connString));
